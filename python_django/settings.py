...
SECRET_KEY = "django-insecure-v%kxk2=+2ykky^=0%y8(@$b$q7pfbl8#%c9j3wobf94jf1=j@w"
...
INSTALLED_APPS = [
    'polls.apps.PollsConfig',  #isso garante que meu app usarará as configurações em polls/apps
